...
then
    ...
    docker run --gpus=all --name $DOCKERNAME -it -d --net=host -e EXEC_BASH=1 -v $THIS_SCRIPT_DIR/../../:/nnfusion -w /root/nnfusion rammer/cuda:10.2-cudnn7-devel-ubuntu16.04 bash 
    docker exec -it $DOCKERNAME bash
fi
