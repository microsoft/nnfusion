...
If you want to try low precision model, you can add `--to_fp16` option when freezing model in above example. For now, only alexnet and vgg11 models are tested.
