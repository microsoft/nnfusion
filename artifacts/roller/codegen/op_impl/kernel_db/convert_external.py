...
param_list = {
    ...
    "FusedBatchNormV3": { # TODO
        'symbol': ['input0', 'input1', 'input2', 'input3', 'input4', 'output0'], # x, scale, offset, mean, variance
        'dtype': ['float*', 'float*', 'float*', 'float*', 'float*', 'float*']
    },
    "Transpose": { # TODO
        'symbol': ['input0', 'input1', 'output0'], # x, axis_order, output
        'dtype': ['float*', 'float*', 'float*']
    },
    "DepthwiseConv2dNative": { # TODO
        'symbol': ['input0', 'input1', 'output0'], # x, filter, output
        'dtype': ['float*', 'float*', 'float*']
    },
    "Dot": {
        'symbol': ['input0', 'input1', 'output0'],
...
def insert_kernel_entry(kernels):
