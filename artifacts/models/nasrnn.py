...
if __name__ == "__main__":
    ...
    if args.mode == 'eval':
        with torch.no_grad():
            ...
            # workflow_fix_flag(model, f"nasrnn_bs{args.bs}", (inputs,), args.platform, args.measure, enable_control_flow=args.cf)
            # workflow_fix_flag(model, f"nasrnn_bs{args.bs}", (inputs,), args.platform, args.measure, enable_control_flow=args.cf, run_unroll=True)
            # dynamic unroll
