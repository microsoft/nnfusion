  ...
  for (int rc_outer = 0; rc_outer < 32; ++rc_outer) {
    ...
    for (int rc_inner = 0; rc_inner < 32; ++rc_inner) {
      ...
      for (int ff_c = 0; ff_c < 4; ++ff_c) {
        compute_local[(ff_c)] = (compute_local[(ff_c)] + (pad_temp_shared[((((rc_inner * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)))] * placeholder_shared[((((((int)threadIdx.z) * 128) + (ff_c * 32)) + rc_inner))]));
        compute_local[((ff_c + 4))] = (compute_local[((ff_c + 4))] + (pad_temp_shared[(((((rc_inner * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)) + 28))] * placeholder_shared[((((((int)threadIdx.z) * 128) + (ff_c * 32)) + rc_inner))]));
        compute_local[((ff_c + 8))] = (compute_local[((ff_c + 8))] + (pad_temp_shared[(((((rc_inner * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)) + 56))] * placeholder_shared[((((((int)threadIdx.z) * 128) + (ff_c * 32)) + rc_inner))]));
        compute_local[((ff_c + 12))] = (compute_local[((ff_c + 12))] + (pad_temp_shared[(((((rc_inner * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)) + 84))] * placeholder_shared[((((((int)threadIdx.z) * 128) + (ff_c * 32)) + rc_inner))]));
        compute_local[((ff_c + 16))] = (compute_local[((ff_c + 16))] + (pad_temp_shared[(((((rc_inner * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)) + 112))] * placeholder_shared[((((((int)threadIdx.z) * 128) + (ff_c * 32)) + rc_inner))]));
        compute_local[((ff_c + 20))] = (compute_local[((ff_c + 20))] + (pad_temp_shared[(((((rc_inner * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)) + 140))] * placeholder_shared[((((((int)threadIdx.z) * 128) + (ff_c * 32)) + rc_inner))]));
        compute_local[((ff_c + 24))] = (compute_local[((ff_c + 24))] + (pad_temp_shared[(((((rc_inner * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)) + 168))] * placeholder_shared[((((((int)threadIdx.z) * 128) + (ff_c * 32)) + rc_inner))]));
      }
    }
  }
  #pragma unroll
