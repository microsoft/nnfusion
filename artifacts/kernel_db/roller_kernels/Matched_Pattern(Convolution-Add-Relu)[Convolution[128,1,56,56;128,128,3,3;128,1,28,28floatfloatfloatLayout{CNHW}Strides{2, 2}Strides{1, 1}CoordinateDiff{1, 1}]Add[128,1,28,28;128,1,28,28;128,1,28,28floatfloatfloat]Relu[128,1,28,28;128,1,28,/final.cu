...
extern "C" __global__ void __launch_bounds__(256) default_function_kernel0(float* __restrict__ data, float* __restrict__ kernel, float* __restrict__ bias, float* __restrict__ conv_unpad) {
  ...
  for (int ra_fused0_outer = 0; ra_fused0_outer < 36; ++ra_fused0_outer) {
    __syncthreads();
    data_pad_shared[(((int)threadIdx.x))] = (((0 < ((((((((int)blockIdx.x) % 49) * 16) + (((int)threadIdx.x) & 15)) / 28) * 2) + ((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) % 9) / 3))) && (0 < ((((((((int)blockIdx.x) % 49) * 16) + (((int)threadIdx.x) & 15)) % 28) * 2) + (((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) % 3)))) ? data[((((((((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) / 9) * 3136) + (((((((int)blockIdx.x) % 49) * 16) + (((int)threadIdx.x) & 15)) / 28) * 112)) + (((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) % 9) / 3) * 56)) + (((((((int)blockIdx.x) % 49) * 16) + (((int)threadIdx.x) & 15)) % 28) * 2)) + (((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) % 3)) - 57))] : 0.000000e+00f);
    data_pad_shared[((((int)threadIdx.x) + 256))] = (((0 < ((((((((int)blockIdx.x) % 49) * 16) + (((int)threadIdx.x) & 15)) / 28) * 2) + (((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) + 7) % 9) / 3))) && (0 < ((((((((int)blockIdx.x) % 49) * 16) + (((int)threadIdx.x) & 15)) % 28) * 2) + ((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) + 1) % 3)))) ? data[(((((((((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) + 16) / 9) * 3136) + (((((((int)blockIdx.x) % 49) * 16) + (((int)threadIdx.x) & 15)) / 28) * 112)) + ((((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) + 7) % 9) / 3) * 56)) + (((((((int)blockIdx.x) % 49) * 16) + (((int)threadIdx.x) & 15)) % 28) * 2)) + ((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) + 1) % 3)) - 57))] : 0.000000e+00f);
