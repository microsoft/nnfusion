...
void InitDefaultsFunctionProtoImpl() {
  ...
  protobuf_onnx_2fonnx_2dml_2eproto::InitDefaultsAttributeProto();
  {
...
void InitDefaultsOperatorSetProtoImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_onnx_2fonnx_2doperators_2dml_2eproto::InitDefaultsOperatorProto();
  protobuf_onnx_2fonnx_2doperators_2dml_2eproto::InitDefaultsFunctionProto();
  {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "onnx/onnx-operators-ml.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
const ::google::protobuf::EnumDescriptor* OperatorStatus_descriptor() {
  protobuf_onnx_2fonnx_2doperators_2dml_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_onnx_2fonnx_2doperators_2dml_2eproto::file_level_enum_descriptors[0];
}
...
const ::google::protobuf::Descriptor* FunctionProto::descriptor() {
  ::protobuf_onnx_2fonnx_2doperators_2dml_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_onnx_2fonnx_2doperators_2dml_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata FunctionProto::GetMetadata() const {
  protobuf_onnx_2fonnx_2doperators_2dml_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_onnx_2fonnx_2doperators_2dml_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
OperatorSetProto::OperatorSetProto()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_onnx_2fonnx_2doperators_2dml_2eproto::InitDefaultsOperatorSetProto();
  }
  SharedCtor();
