...
//             "mediate1[N,C] +=! (input0[N,C,@I@] * input0[N,C,@I@]);"
//             "@output0@[N, C, @I@] = @input2@[C] + @input1@[C] * (@input0@[N, C, @I@] * @dims@ - "
//             "mediate0[N,C]) * (@epsilon@ + mediate1[N,C] * @dims@ - mediate0[N,C] * mediate0[N,C] ).call(`rsqrt`);",
