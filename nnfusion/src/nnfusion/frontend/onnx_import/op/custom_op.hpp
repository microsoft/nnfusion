    ...
    namespace frontend
    {
        namespace onnx_import
        {
                                              ...
                                              int64_t version)
            {
                ...
                myConfig["domain"] = node_proto.domain();
                ...
                for (const auto& attr : attrs)
                {
                    ...
                    else if (attr.is_tensor())
                    {
                        ...
                        {
                            NNFUSION_CHECK_FAIL() << "Unsupported attribute type: Tensor " << type;
                        }
                    }
                    else
                    {
                ...
                auto generic_gnode =
                    m_graph->add_node_and_edge(generic_op, input_indexes, node_proto.output_size());
