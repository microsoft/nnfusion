...
void Result_float_float_cuda_lib_Result_16(hipStream_t stream, float* input0, float* output0)
{
    if (input0 != output0)
...
extern void FusedKernel_float_float_float_cuda_Broadcast_Add_1_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, float* input0, float* input1, float* output0) {
    hipLaunchKernelGGL(FusedKernel_float_float_float_cuda_Broadcast_Add_1, grids, blocks, mem, stream, input0, input1, output0);
}
...
void Constant_int64_t_cuda_Constant_11(hipStream_t stream, int64_t* output0)
{
...
void Result_int64_t_int64_t_cuda_lib_Result_14(hipStream_t stream, int64_t* input0, int64_t* output0)
{
    if (input0 != output0)
...
CUDA_SAFE_CALL(hipMalloc((void**)&group_persist_CUDA_GPU0_allocator_memory_pool,393408));
CUDA_SAFE_CALL(hipMemset((void*)group_persist_CUDA_GPU0_allocator_memory_pool, 0, 393408));
