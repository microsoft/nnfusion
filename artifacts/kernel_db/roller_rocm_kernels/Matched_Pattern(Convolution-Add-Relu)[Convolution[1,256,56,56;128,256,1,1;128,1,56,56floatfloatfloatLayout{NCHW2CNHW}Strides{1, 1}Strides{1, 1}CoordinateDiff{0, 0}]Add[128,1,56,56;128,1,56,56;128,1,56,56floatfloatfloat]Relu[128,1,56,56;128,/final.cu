...
extern "C" __global__ void __launch_bounds__(256) default_function_kernel0(float* __restrict__ data, float* __restrict__ kernel, float* __restrict__ bias, float* __restrict__ conv_unpad) {
  ...
  conv_unpad[((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 50176)] = max((conv_local[4] + bias[((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 16)]), 0.000000e+00f);
  ...
  conv_unpad[((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 50192)] = max((conv_local[5] + bias[((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 16)]), 0.000000e+00f);
  ...
  conv_unpad[((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 50208)] = max((conv_local[6] + bias[((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 16)]), 0.000000e+00f);
  ...
  conv_unpad[((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 50224)] = max((conv_local[7] + bias[((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 16)]), 0.000000e+00f);
}
