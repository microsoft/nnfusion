...
class DataFormat(object):
    ...
    Attributes:
        ...
        reference: Keep a reference to origin data structure, to avoid gc
    """
...
def cast_pytorch_tensor(pytorch_tensor):
    if not pytorch_tensor.is_contiguous():
        raise Exception("Cannot cast incontiguous tensor, please use tensor.detach().clone().contiguous() before casting.")
