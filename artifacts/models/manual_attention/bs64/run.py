from Modelattention_bs64_0_nnfusion import GenModel as Model0
from Modelattention_bs64_1_nnfusion import GenModel as Model1
...
class Attention(nn.Module):
    def __init__(self):
        super().__init__()
        self.__attention_bs64_0 = Model0()
        self.__attention_bs64_1 = Model1()

    def forward(self, x, k, v):
        (gen_id, v, k) = self.__attention_bs64_1.apply(v, k)
        for i in range(32):
            (gen_id, _, x, _) = self.__attention_bs64_0.apply(gen_id, v, x, k)
        return (k, v, x)
