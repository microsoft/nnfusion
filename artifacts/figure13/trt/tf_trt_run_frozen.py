...
flags.DEFINE_integer("warmup", 5, "num of iterations")
...
class NasnetImagenetNchw(BaseNet):
    def __init__(self):
        self.name = "nasnet_imagenet_nchw"
        self.image_size = (1, 224, 224, 3)
        self.output_node = ["final_layer/FC/BiasAdd"]

class ResNextImagenetNchw(BaseNet):
    def __init__(self):
        self.name = "resnext_imagenet_nchw"
