...
set term pdfcairo monochrome enhanced font "Times-New-Roman, 8" size 2.6,0.8
set output 'figure11_reproduce.pdf'
...
set title "ResNeXt" font "Times-New-Roman, 9.5" offset 0,-9.5
@YTICS
set yrange[0:100]
set ytics 25
...
plot newhistogram lt 1, \
     'gpu1_batch_cuda_resnext.dat' 	u 2:xtic(1) title "TF" fs pattern 0 lt 1, \
...
set lmargin at screen lft(currentcolumn,m,l,g)
set rmargin at screen rgt(currentcolumn,m,l,g)
set title "LSTM" font "Times-New-Roman, 9.5" offset 0,-9.5
@NOYTICS
set yrange [0:200]
set ytics 50
set xlabel offset 0,1
plot newhistogram lt 1, \
     'gpu1_batch_cuda_lstm.dat' 	u 2:xtic(1) title "TF" fs pattern 0 lt 1, \
						''	u 3 title "TF-XLA" fs pattern 6 ls -1, \
						''	u 4 title "TF-TRT" fs pattern 7 ls -1, \
						''	u 5 title "TVM" fs pattern 2 ls -1, \
