...
flags.DEFINE_string("profile_log",
                    "manual_dense_nn/profile.log", "path of profile log")
...
def manual_dot_codegen(m, k, n):
    ...
    code_file = "manual_dense_nn/" + op_name + ".cu"
...
def extract_ops_from_log():
    ...
    dot_ops.append({'arg0_shape': [1, 256], 'arg1_shape': [256, 512], 'out_shape': [1, 512], 'transpose_A': False, 'transpose_B': False})
    dot_ops.append({'arg0_shape': [1, 512], 'arg1_shape': [512, 1024], 'out_shape': [1, 1024], 'transpose_A': False, 'transpose_B': False})
    dot_ops.append({'arg0_shape': [1, 3008], 'arg1_shape': [3008, 1024], 'out_shape': [1, 1024], 'transpose_A': False, 'transpose_B': False})
    return dot_ops
