...
def load_model(model_path: str):
    ...
    codegen_flags = {'autodiff': False, 'training_mode': False, 'extern_result_memory': True, 'codegen_unexist_kernel': True, 'product_name': 'V100', 'default_device': 'ROCM_GPU'}
    rt_dir = os.path.join(workdir, "nnfusion_rt/rocm_codegen")
...
class GenModel(torch.autograd.Function):
    ...
    def forward(ctx, _i0, _i1, _i2, _i3, _i4, _i5):
        ...
        tmp_i1=cast_pytorch_tensor(torch.full((), _i1, device=cuda_device))
