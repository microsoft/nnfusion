...
cuda_cpu::Slice::Slice(shared_ptr<KernelContext> ctx)
    : CPUOpEmitter(ctx)
{
...
bool cuda_cpu::Slice::is_eliminative()
{
...
LanguageUnit_p cuda_cpu::Slice::emit_function_body()
{
...
LanguageUnit_p cuda_cpu::Slice::emit_dependency()
{
