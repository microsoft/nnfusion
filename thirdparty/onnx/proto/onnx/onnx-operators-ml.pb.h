...
class FunctionProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx.FunctionProto) */ {
 ...
 private:
  ...
  int status_;
  friend struct ::protobuf_onnx_2fonnx_2doperators_2dml_2eproto::TableStruct;
  friend void ::protobuf_onnx_2fonnx_2doperators_2dml_2eproto::InitDefaultsFunctionProtoImpl();
};
// -------------------------------------------------------------------
...
class OperatorProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx.OperatorProto) */ {
 ...
 private:
  ...
  int status_;
  friend struct ::protobuf_onnx_2fonnx_2doperators_2dml_2eproto::TableStruct;
  friend void ::protobuf_onnx_2fonnx_2doperators_2dml_2eproto::InitDefaultsOperatorProtoImpl();
};
// -------------------------------------------------------------------
...
class OperatorSetProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx.OperatorSetProto) */ {
 ...
 private:
  ...
  friend struct ::protobuf_onnx_2fonnx_2doperators_2dml_2eproto::TableStruct;
  friend void ::protobuf_onnx_2fonnx_2doperators_2dml_2eproto::InitDefaultsOperatorSetProtoImpl();
};
// ===================================================================
