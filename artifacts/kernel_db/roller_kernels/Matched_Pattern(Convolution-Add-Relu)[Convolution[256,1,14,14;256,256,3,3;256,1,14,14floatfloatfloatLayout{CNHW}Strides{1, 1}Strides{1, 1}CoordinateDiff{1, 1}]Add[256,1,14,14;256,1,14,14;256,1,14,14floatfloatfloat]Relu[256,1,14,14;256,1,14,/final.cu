...
extern "C" __global__ void __launch_bounds__(256) default_function_kernel0(float* __restrict__ data, float* __restrict__ kernel, float* __restrict__ bias, float* __restrict__ conv_unpad) {
  ...
  for (int ra_fused0_outer = 0; ra_fused0_outer < 72; ++ra_fused0_outer) {
    __syncthreads();
    data_pad_shared[(((int)threadIdx.x))] = (((((((((((int)blockIdx.x) % 13) * 16) + (((int)threadIdx.x) & 15)) < 196) && (0 < ((((((((int)blockIdx.x) % 13) * 16) + (((int)threadIdx.x) & 15)) % 196) / 14) + ((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) % 9) / 3)))) && (((((((((int)blockIdx.x) % 13) * 16) + (((int)threadIdx.x) & 15)) % 196) / 14) + ((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) % 9) / 3)) < 15)) && (0 < (((((((int)blockIdx.x) % 13) * 16) + (((int)threadIdx.x) & 15)) % 14) + (((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) % 3)))) && ((((((((int)blockIdx.x) % 13) * 16) + (((int)threadIdx.x) & 15)) % 14) + (((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) % 3)) < 15)) ? data[((((((((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) / 9) * 196) + ((((int)blockIdx.x) % 13) * 16)) + (((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) % 9) / 3) * 14)) + (((int)threadIdx.x) & 15)) + (((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) % 3)) - 15))] : 0.000000e+00f);
    data_pad_shared[((((int)threadIdx.x) + 256))] = (((((((((((int)blockIdx.x) % 13) * 16) + (((int)threadIdx.x) & 15)) < 196) && (0 < ((((((((int)blockIdx.x) % 13) * 16) + (((int)threadIdx.x) & 15)) % 196) / 14) + (((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) + 7) % 9) / 3)))) && (((((((((int)blockIdx.x) % 13) * 16) + (((int)threadIdx.x) & 15)) % 196) / 14) + (((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) + 7) % 9) / 3)) < 15)) && (0 < (((((((int)blockIdx.x) % 13) * 16) + (((int)threadIdx.x) & 15)) % 14) + ((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) + 1) % 3)))) && ((((((((int)blockIdx.x) % 13) * 16) + (((int)threadIdx.x) & 15)) % 14) + ((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) + 1) % 3)) < 15)) ? data[(((((((((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) + 16) / 9) * 196) + ((((int)blockIdx.x) % 13) * 16)) + ((((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) + 7) % 9) / 3) * 14)) + (((int)threadIdx.x) & 15)) + ((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 4)) + 1) % 3)) - 15))] : 0.000000e+00f);
