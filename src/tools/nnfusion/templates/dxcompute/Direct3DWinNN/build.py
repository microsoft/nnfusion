...
def copy_to_output(output_dir, build_type, platform):
    ...
    nnf_desktop_dir = r".\nnf_desktop_example"
    hlsl_path = os.path.join(nnf_desktop_dir, "HLSL")
    const_path = os.path.join(nnf_desktop_dir, "Constant")
...
def setup_parser():
    ...
    parser.add_argument("-p", "--platform", default="x64")
