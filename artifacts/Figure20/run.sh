...
cp -r ${ARTIFACT_ROOT}/reproduce_results/Figure14/grinder ${ARTIFACT_ROOT}/reproduce_results/Figure20
...
cp ${ARTIFACT_ROOT}/reproduce_results/Figure14/grinder/nasrnn.b1.log ${LOG_DIR}
python3 attention.py --platform V100 --bs 1 --no-torch --measure --enable-breakdown 2>&1 | tee $LOG_DIR/attention.b1.log
cp ${ARTIFACT_ROOT}/reproduce_results/Figure14/grinder/seq2seq.b1.log ${LOG_DIR}
