...
set term pdfcairo monochrome enhanced font "Times-New-Roman, 8" size 2.8,1
set output 'figure13_paper.pdf'
...
set title "ResNeXt" font "Times-New-Roman, 9.5" offset 0,-6
@YTICS
set yrange[0:500]
#set ytics 25
...
plot newhistogram lt 1, \
     'gpu1_imgnet_cuda_resnext.dat' 	u 2 title "TF" fs pattern 0 lt 1, \
						''	u 3 title "TF-XLA" fs pattern 6 ls -1, \
						''	u 4 title "TF-TRT" fs pattern 7 ls -1, \
						''	u 5 title "TVM" fs pattern 2 ls -1, \
						''	u 6 title "RammerBase" fs solid 0.4 ls -1 lw 1, \
						''	u 7 title "Rammer" fs solid 1 ls -1 lw 1
...
set lmargin at screen lft(currentcolumn,m,l,g)
set rmargin at screen rgt(currentcolumn,m,l,g)
set title "NASNet" font "Times-New-Roman, 9.5" offset 0,-6
@NOYTICS
set yrange [0:30]
#set ytics 50
set xlabel offset 0,1
plot newhistogram lt 1, \
     'gpu1_imgnet_cuda_nasnet.dat' 	u 2 title "TF" fs pattern 0 lt 1, \
						''	u 3 title "TF-XLA" fs pattern 6 ls -1, \
						''	u 4 title "TF-TRT" fs pattern 7 ls -1, \
						''	u 5 title "TVM" fs pattern 2 ls -1, \
						''	u 6 title "RammerBase" fs solid 0.4 ls -1 lw 1, \
...
set bmargin at screen top(-0.1,n,h,t,b)
...
plot	0 with boxes title "TF" fs pattern 0 lt 1, \
		...
		0 with boxes title "RammerBase" fs solid 0.4 ls -1 lw 1, \
		0 with boxes title "Rammer" fs solid 1 ls -1 lw 1
