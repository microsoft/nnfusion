...
def generate_pooling_cuda(source_code, grid, block, pool_type, N, C, H, W, K, S, P, entry_point):
...
def execute(path):
    with open(path, "r") as f:
        ...
        if "ansor" in filename:
            ...
            entry_point = "default_function_kernel0"
        generated = generate_pooling_cuda(kernel, launch_config[0:3], launch_config[3:], *param, entry_point)
