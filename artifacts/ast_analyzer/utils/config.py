...
# TMP_DIR = f"/home/heheda/control_flow/ControlFlow/models/tmp"
NNFUSION_ROOT = os.path.normpath(os.path.join(os.path.dirname(os.path.realpath(__file__)), '../../nnfusion'))
