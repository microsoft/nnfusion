...
def _rnn_layer(inputs, rnn_cell, rnn_hidden_size, seq_length, layer_id):
...
class DeepSpeech2(object):
  ...
  def __call__(self, inputs, training):
    ...
    for layer_counter in xrange(self.num_rnn_layers):
      inputs = _rnn_layer(
          inputs, rnn_cell, self.rnn_hidden_size, rnn_length, layer_counter + 1)
