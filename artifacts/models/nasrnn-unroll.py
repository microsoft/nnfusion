...
class NasRNNBySplit(nn.Module):
    ...
    def forward(self, inputs):  # seq_len, batch, input_size
        ...
        for i in range(1000): # change to 1000 for fully unrolled exp
            inp = inputs[i]
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        workflow_fix_flag(model, f"nasrnn_bs{args.bs}_unroll", (inputs,), args.platform, args.measure, run_unroll=True, enable_control_flow=args.cf)