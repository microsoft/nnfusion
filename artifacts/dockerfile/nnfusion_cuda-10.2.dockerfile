...
RUN git clone https://github.com/apache/tvm /root/nnfusion/artifacts/.deps/tvm-0.8-codegen && cd /root/nnfusion/artifacts/.deps/tvm-0.8-codegen && git checkout 22ba6523cbd14fc44a1b093c482c1d02f3bc4fa5 && patch -p0 -i /root/nnfusion/artifacts/dockerfile/tvm-codegen.diff
