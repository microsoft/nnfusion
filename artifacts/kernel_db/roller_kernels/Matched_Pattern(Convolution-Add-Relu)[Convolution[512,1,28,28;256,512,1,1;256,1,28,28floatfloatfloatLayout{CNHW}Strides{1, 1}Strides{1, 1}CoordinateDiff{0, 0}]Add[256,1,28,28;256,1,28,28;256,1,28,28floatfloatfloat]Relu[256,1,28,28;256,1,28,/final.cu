...
extern "C" __global__ void __launch_bounds__(256) default_function_kernel0(float* __restrict__ data, float* __restrict__ kernel, float* __restrict__ bias, float* __restrict__ conv_unpad) {
  ...
  for (int ra_fused0_outer = 0; ra_fused0_outer < 16; ++ra_fused0_outer) {
    ...
    kernel_pad_shared[(((int)threadIdx.x))] = kernel[((((((((int)blockIdx.x) / 25) * 16384) + ((((int)threadIdx.x) >> 5) * 512)) + (ra_fused0_outer * 32)) + (((int)threadIdx.x) & 31)))];
    kernel_pad_shared[((((int)threadIdx.x) + 256))] = kernel[(((((((((int)blockIdx.x) / 25) * 16384) + ((((int)threadIdx.x) >> 5) * 512)) + (ra_fused0_outer * 32)) + (((int)threadIdx.x) & 31)) + 4096))];
    kernel_pad_shared[((((int)threadIdx.x) + 512))] = kernel[(((((((((int)blockIdx.x) / 25) * 16384) + ((((int)threadIdx.x) >> 5) * 512)) + (ra_fused0_outer * 32)) + (((int)threadIdx.x) & 31)) + 8192))];
    kernel_pad_shared[((((int)threadIdx.x) + 768))] = kernel[(((((((((int)blockIdx.x) / 25) * 16384) + ((((int)threadIdx.x) >> 5) * 512)) + (ra_fused0_outer * 32)) + (((int)threadIdx.x) & 31)) + 12288))];
    __syncthreads();
  ...
  conv_unpad[((((((((int)blockIdx.x) / 25) * 25088) + ((((int)threadIdx.x) >> 4) * 784)) + ((((int)blockIdx.x) % 25) * 32)) + (((int)threadIdx.x) & 15)))] = max((conv_local[(0)] + bias[((((((int)blockIdx.x) / 25) * 32) + (((int)threadIdx.x) >> 4)))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 25) * 25088) + ((((int)threadIdx.x) >> 4) * 784)) + ((((int)blockIdx.x) % 25) * 32)) + (((int)threadIdx.x) & 15)) + 12544))] = max((conv_local[(2)] + bias[(((((((int)blockIdx.x) / 25) * 32) + (((int)threadIdx.x) >> 4)) + 16))]), 0.000000e+00f);
  if ((((((int)blockIdx.x) % 25) * 32) + (((int)threadIdx.x) & 15)) < 768) {
    conv_unpad[(((((((((int)blockIdx.x) / 25) * 25088) + ((((int)threadIdx.x) >> 4) * 784)) + ((((int)blockIdx.x) % 25) * 32)) + (((int)threadIdx.x) & 15)) + 16))] = max((conv_local[(1)] + bias[((((((int)blockIdx.x) / 25) * 32) + (((int)threadIdx.x) >> 4)))]), 0.000000e+00f);
    conv_unpad[(((((((((int)blockIdx.x) / 25) * 25088) + ((((int)threadIdx.x) >> 4) * 784)) + ((((int)blockIdx.x) % 25) * 32)) + (((int)threadIdx.x) & 15)) + 12560))] = max((conv_local[(3)] + bias[(((((((int)blockIdx.x) / 25) * 32) + (((int)threadIdx.x) >> 4)) + 16))]), 0.000000e+00f);
  }
}
