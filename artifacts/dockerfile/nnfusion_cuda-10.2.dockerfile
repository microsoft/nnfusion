...
RUN git clone https://github.com/microsoft/nnfusion.git /root/nnfusion --branch osdi20_artifact --single-branch
...
# Clone source code
RUN git clone https://github.com/apache/incubator-tvm /root/nnfusion/artifacts/.deps/tvm-0.7 && cd /root/nnfusion/artifacts/.deps/tvm-0.7 && git checkout 24c53a343b0ecb76ed766d3f29e968ee0f8b0816
RUN git clone https://github.com/apache/incubator-tvm /root/nnfusion/artifacts/.deps/tvm-0.7-codegen && cd /root/nnfusion/artifacts/.deps/tvm-0.7-codegen && git checkout 24c53a343b0ecb76ed766d3f29e968ee0f8b0816 && patch -p0 -i /root/nnfusion/artifacts/dockerfile/tvm-codegen.diff
...
RUN cd /root/nnfusion/artifacts/.deps/ && wget https://versaweb.dl.sourceforge.net/project/gnuplot/gnuplot/5.2.8/gnuplot-5.2.8.tar.gz && tar zxf gnuplot-5.2.8.tar.gz && cd gnuplot-5.2.8 && ./configure && make -j && make install
...
export TVM_HOME=$ARTIFACTS_HOME/.deps/tvm-0.7 \n\
export GNUTERM=dumb \n\
