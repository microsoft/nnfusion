...
def init_intrin_strides(wmma_shape, warp_s, block_s, rstep_size, offset,
                        layout):
...
def intrin_wmma_load_matrix(wmma_shape, warp_shape, block_shape, rstep,
                            stride_dst, stride_src, scope, layout, data_dtype):
...
def intrin_wmma_gemm(AL_gemm, BL_gemm, CL_compute, strides_A, strides_B,
                     strides_C, shape):
