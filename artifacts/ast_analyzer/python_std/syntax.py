...
from ast_analyzer.python_std.typing import Tuple, List, Set, Dict
from ast_analyzer.python_std.utils import isstr
...
def check_specs(specs, types):
    ...
    '''
    from ast_analyzer.python_std.types.tog import unify, clone, tr
    from ast_analyzer.python_std.types.tog import Function, TypeVariable, InferenceError
