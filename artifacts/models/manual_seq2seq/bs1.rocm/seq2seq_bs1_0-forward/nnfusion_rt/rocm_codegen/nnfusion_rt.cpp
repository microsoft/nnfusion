...
#define DEBUG_TENSOR(tensor, size) { \
    printf("%s: ", #tensor); \
    hipLaunchKernelGGL((printTensor), 1, 1, tensor, size); \
...
#define DEBUG_TENSOR_CHAR(tensor, size) { \
    printf("%s: ", #tensor); \
    hipLaunchKernelGGL((printTensorChar), 1, 1, tensor, size); \
    CUDA_SAFE_CALL(hipDeviceSynchronize()); \
    fflush(stdout); \
    printf("\n"); \
}
...
#define DEBUG_TENSOR1(tensor, n, c, stride) { \
    printf("%s: ", #tensor); \
    hipLaunchKernelGGL((printTensor3D), 1, 1, tensor, n, c, stride); \
    CUDA_SAFE_CALL(hipDeviceSynchronize()); \
    fflush(stdout); \
    printf("\n"); \
}
...
char* group_0_ROCM_GPU0_allocator_memory_pool;
float* GatherV2_19_0;
float* GatherV2_82_0;
float* Reshape_21_0;
float* Reshape_26_0;
...
char* Less_94_0;
char* Greater_92_0;
char* group_persist_ROCM_GPU0_allocator_memory_pool;
...
// Input:
//	- name: Parameter_18_0	type: int64_t	shape: Shape{50, 1}
...
extern void ScatterND_int64_t_int64_t_int64_t_int64_t_cuda_ScatterND_87_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, int64_t* input0, int64_t* input1, int64_t* input2, int64_t* output0) {
    hipLaunchKernelGGL((ScatterND_int64_t_int64_t_int64_t_int64_t_cuda_ScatterND_87), grids, blocks, mem, stream, input0, input1, input2, output0);
}
    ...
    {
        {
            ...
            for (int k = 0; k < 256; k += 64) {
                #pragma unroll
                for (int i = warp_id; i < 16; i += 4) if (blockIdx.x * 16 + i < num_tasks) share_b[i * XX + lane_id] = input1[block_start + i * 256 + k + lane_id];
                __syncthreads();
                // if (threadIdx.x == 0) { printf("shareb k=%d:", k); for (int i = 0; i < 32; i++) printf("%f ", share_b[i]); printf("\n");}
                #pragma unroll
                for (int j = in_task_id; j < 64; j += 16) s += share_a[k + j] * share_b[task_id_in_block * XX + j];
                __syncthreads();
            }
            s += __shfl_xor(s, 8);
            s += __shfl_xor(s, 4);
...
extern void Dot_float_float_float_cuda_Dot_77_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, float* __restrict__ input0, float* __restrict__ input1, float* __restrict__ output0) {
    hipLaunchKernelGGL((Dot_float_float_float_cuda_Dot_77), grids, blocks, mem, stream, input0, input1, output0);
}
// Node name:	Reshape_21
// Description:	Reshape
// Input:
//	- name: Parameter_16_0	type: float	shape: Shape{1, 256}
// Output:
...
extern void Reshape_float_float_cuda_Reshape_21_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, float* input0, float* output0) {
    hipLaunchKernelGGL((Reshape_float_float_cuda_Reshape_21), grids, blocks, mem, stream, input0, output0);
}
// Node name:	 BlockFusion
// Input:
//	- name: Constant_0_0	type: float	shape: Shape{3797, 256}
//	- name: Parameter_13_0	type: int64_t	shape: Shape{1}
//	- name: Parameter_17_0	type: float	shape: Shape{50, 1, 3797}
//	- name: Parameter_14_0	type: int64_t	shape: Shape{}
...
// Fused functions:
// hipLaunchKernelGGL((GatherV2_float_int64_t_float_cuda_GatherV2_19), dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, Constant_0_0, Parameter_13_0, GatherV2_19_0);
// hipLaunchKernelGGL((GatherV2_float_int64_t_float_cuda_GatherV2_82), dim3(15, 1, 1), dim3(256, 1, 1), 0, 0, Parameter_17_0, Parameter_14_0, GatherV2_82_0);
// hipLaunchKernelGGL((Add_int64_t_int64_t_int64_t_cuda_Add_89), dim3(1, 1, 1), dim3(1, 1, 1), 0, 0, Parameter_14_0, Constant_88_0, id_1);
...
extern void BlockFusionKernel_float_int64_t_float_int64_t_int64_t_float_float_int64_t_cuda_GatherV2_GatherV2_Add_0_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, float* input0, int64_t* input1, float* input2, int64_t* input3, int64_t* input4, float* output0, float* output1, int64_t* output2) {
    hipLaunchKernelGGL((BlockFusionKernel_float_int64_t_float_int64_t_int64_t_float_float_int64_t_cuda_GatherV2_GatherV2_Add_0), grids, blocks, mem, stream, input0, input1, input2, input3, input4, output0, output1, output2);
}
...
extern void Sum_int64_t_int64_t_cuda_Sum_90_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, int64_t* input0, int64_t* output0) {
    hipLaunchKernelGGL((Sum_int64_t_int64_t_cuda_Sum_90), grids, blocks, mem, stream, input0, output0);
}
...
extern void FusedKernel_float_float_float_float_cuda_Add_Reshape_Add_1_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, float* input0, float* input1, float* input2, float* output0) {
    hipLaunchKernelGGL((FusedKernel_float_float_float_float_cuda_Add_Reshape_Add_1), grids, blocks, mem, stream, input0, input1, input2, output0);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// hipLaunchKernelGGL((GatherV2_float_int64_t_float_cuda_GatherV2_31), dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, Reshape_25_0, Constant_30_0, GatherV2_31_0);
// hipLaunchKernelGGL((GatherV2_float_int64_t_float_cuda_GatherV2_39), dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, Reshape_25_0, Constant_38_0, GatherV2_39_0);
// hipLaunchKernelGGL((GatherV2_float_int64_t_float_cuda_GatherV2_47), dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, Reshape_25_0, Constant_46_0, GatherV2_47_0);
// hipLaunchKernelGGL((GatherV2_float_int64_t_float_cuda_GatherV2_55), dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, Reshape_25_0, Constant_54_0, GatherV2_55_0);
// hipLaunchKernelGGL((GatherV2_float_int64_t_float_cuda_GatherV2_35), dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, Reshape_29_0, Constant_34_0, GatherV2_35_0);
// hipLaunchKernelGGL((GatherV2_float_int64_t_float_cuda_GatherV2_43), dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, Reshape_29_0, Constant_42_0, GatherV2_43_0);
// hipLaunchKernelGGL((GatherV2_float_int64_t_float_cuda_GatherV2_51), dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, Reshape_29_0, Constant_50_0, GatherV2_51_0);
// hipLaunchKernelGGL((GatherV2_float_int64_t_float_cuda_GatherV2_59), dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, Reshape_29_0, Constant_58_0, GatherV2_59_0);
// Deduped function map: <src_function_name : deduped_function_name>
// GatherV2_float_int64_t_float_cuda_GatherV2_39 : GatherV2_float_int64_t_float_cuda_GatherV2_31
// GatherV2_float_int64_t_float_cuda_GatherV2_47 : GatherV2_float_int64_t_float_cuda_GatherV2_31
// GatherV2_float_int64_t_float_cuda_GatherV2_55 : GatherV2_float_int64_t_float_cuda_GatherV2_31
// GatherV2_float_int64_t_float_cuda_GatherV2_35 : GatherV2_float_int64_t_float_cuda_GatherV2_31
// GatherV2_float_int64_t_float_cuda_GatherV2_43 : GatherV2_float_int64_t_float_cuda_GatherV2_31
// GatherV2_float_int64_t_float_cuda_GatherV2_51 : GatherV2_float_int64_t_float_cuda_GatherV2_31
// GatherV2_float_int64_t_float_cuda_GatherV2_59 : GatherV2_float_int64_t_float_cuda_GatherV2_31

// Node name:	GatherV2_31
// Description:	GatherV2
// Input:
//	- name: Reshape_25_0	type: float	shape: Shape{4, 1, 256}
//	- name: Constant_30_0	type: int64_t	shape: Shape{}
// Output:
//	- name: GatherV2_31_0	type: float	shape: Shape{1, 256}
__device__ __noinline__ void GatherV2_float_int64_t_float_cuda_GatherV2_31_block_kernel(float* input0, int64_t* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_int64_t_int64_t_int64_t_int64_t_float_int64_t_int64_t_int64_t_int64_t_float_float_float_float_float_float_float_float_cuda_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_2(float* input0, int64_t* input1, int64_t* input2, int64_t* input3, int64_t* input4, float* input5, int64_t* input6, int64_t* input7, int64_t* input8, int64_t* input9, float* output0, float* output1, float* output2, float* output3, float* output4, float* output5, float* output6, float* output7)
{
    ...
    if (blockIdx.x == 0)
    {
        GatherV2_float_int64_t_float_cuda_GatherV2_31_block_kernel(input0, input1, output0, threadIdx.x, 0, NULL);
    }
    else if (blockIdx.x == 1)
    {
        GatherV2_float_int64_t_float_cuda_GatherV2_31_block_kernel(input0, input2, output1, threadIdx.x, 0, NULL);
    }
    else if (blockIdx.x == 2)
    {
        GatherV2_float_int64_t_float_cuda_GatherV2_31_block_kernel(input0, input3, output2, threadIdx.x, 0, NULL);
    }
    else if (blockIdx.x == 3)
    {
        GatherV2_float_int64_t_float_cuda_GatherV2_31_block_kernel(input0, input4, output3, threadIdx.x, 0, NULL);
    }
    else if (blockIdx.x == 4)
    {
        GatherV2_float_int64_t_float_cuda_GatherV2_31_block_kernel(input5, input6, output4, threadIdx.x, 0, NULL);
    }
    else if (blockIdx.x == 5)
    {
        GatherV2_float_int64_t_float_cuda_GatherV2_31_block_kernel(input5, input7, output5, threadIdx.x, 0, NULL);
    }
    else if (blockIdx.x == 6)
    {
        GatherV2_float_int64_t_float_cuda_GatherV2_31_block_kernel(input5, input8, output6, threadIdx.x, 0, NULL);
    }
    else if (blockIdx.x == 7)
    {
        GatherV2_float_int64_t_float_cuda_GatherV2_31_block_kernel(input5, input9, output7, threadIdx.x, 0, NULL);
    }
...
extern void BlockFusionKernel_float_int64_t_int64_t_int64_t_int64_t_float_int64_t_int64_t_int64_t_int64_t_float_float_float_float_float_float_float_float_cuda_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_2_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, float* input0, int64_t* input1, int64_t* input2, int64_t* input3, int64_t* input4, float* input5, int64_t* input6, int64_t* input7, int64_t* input8, int64_t* input9, float* output0, float* output1, float* output2, float* output3, float* output4, float* output5, float* output6, float* output7) {
    hipLaunchKernelGGL((BlockFusionKernel_float_int64_t_int64_t_int64_t_int64_t_float_int64_t_int64_t_int64_t_int64_t_float_float_float_float_float_float_float_float_cuda_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_2), grids, blocks, mem, stream, input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, output0, output1, output2, output3, output4, output5, output6, output7);
}
...
// Output:
//	- name: Result_96_0	type: char	shape: Shape{}
void Result_char_char_cuda_lib_Result_96(hipStream_t stream, char* input0, char* output0)
{
    if (input0 != output0)
...
extern void Less_int64_t_int64_t_char_cuda_Less_94_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, int64_t* input0, int64_t* input1, char* output0) {
    hipLaunchKernelGGL((Less_int64_t_int64_t_char_cuda_Less_94), grids, blocks, mem, stream, input0, input1, output0);
}
// Node name:	 Elementwise Kernel Fusion
// Input:
//	- name: GatherV2_51_0	type: float	shape: Shape{1, 256}
...
extern void FusedKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Add_Add_Add_Tanh_Add_Add_Add_Sigmoid_Multiply_Add_Add_Add_Sigmoid_Multiply_Add_Tanh_Add_Add_Add_Sigmoid_Multiply_0_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* input10, float* input11, float* input12, float* input13, float* input14, float* input15, float* input16, float* output0, float* output1) {
    hipLaunchKernelGGL((FusedKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Add_Add_Add_Tanh_Add_Add_Add_Sigmoid_Multiply_Add_Add_Add_Sigmoid_Multiply_Add_Tanh_Add_Add_Add_Sigmoid_Multiply_0), grids, blocks, mem, stream, input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, input10, input11, input12, input13, input14, input15, input16, output0, output1);
}
// Node name:	Result_98
// Description:	Result
// Input:
//	- name: tensor_87	type: int64_t	shape: Shape{50, 1}
// Output:
//	- name: Result_98_0	type: int64_t	shape: Shape{50, 1}
void Result_int64_t_int64_t_cuda_lib_Result_98(hipStream_t stream, int64_t* input0, int64_t* output0)
{
    if (input0 != output0)
        CUDA_SAFE_CALL(hipMemcpyAsync(output0, input0,400, hipMemcpyDeviceToDevice, stream));
}
...
CUDA_SAFE_CALL(hipMalloc((void**)&group_0_ROCM_GPU0_allocator_memory_pool,64320));
CUDA_SAFE_CALL(hipMemset((void*)group_0_ROCM_GPU0_allocator_memory_pool, 0, 64320));
GatherV2_19_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+0);
GatherV2_82_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+1024);
Reshape_21_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+16256);
Reshape_26_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+16256);
Reshape_22_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+0);
BatchMatMul_28_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+17280);
BatchMatMul_24_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+21376);
Reshape_29_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+17280);
Reshape_25_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+21376);
GatherV2_51_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+25472);
GatherV2_43_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+26496);
GatherV2_39_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+27520);
GatherV2_59_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+28544);
GatherV2_47_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+29568);
GatherV2_55_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+30592);
GatherV2_31_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+31616);
GatherV2_35_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+32640);
Dot_77_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+33664);
Add_83_0 = (float*)(group_0_ROCM_GPU0_allocator_memory_pool+48896);
Reshape_86_0 = (int64_t*)(group_0_ROCM_GPU0_allocator_memory_pool+64128);
Less_94_0 = (char*)(group_0_ROCM_GPU0_allocator_memory_pool+64192);
Greater_92_0 = (char*)(group_0_ROCM_GPU0_allocator_memory_pool+64256);
CUDA_SAFE_CALL(hipSetDevice(0));
CUDA_SAFE_CALL(hipMalloc((void**)&group_persist_ROCM_GPU0_allocator_memory_pool,9899776));
CUDA_SAFE_CALL(hipMemset((void*)group_persist_ROCM_GPU0_allocator_memory_pool, 0, 9899776));
Constant_88_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+0);
Constant_0_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+64);
id_1 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+3888192);
Constant_12_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+3888256);
Reshape_78_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+3888256);
Constant_11_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+3903488);
Constant_9_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+7791616);
Reshape_56_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+7791616);
Constant_58_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+7792640);
Constant_2_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+7792704);
Reshape_27_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+7792704);
Constant_1_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+8841280);
Reshape_23_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+8841280);
Constant_50_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+9889856);
Constant_42_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+9889920);
Constant_34_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+9889984);
Constant_54_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+9890048);
Constant_46_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+9890112);
Constant_38_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+9890176);
Constant_30_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+9890240);
Constant_10_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9890304);
Reshape_60_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9890304);
Constant_5_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9891328);
Reshape_40_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9891328);
Constant_6_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9892352);
Reshape_44_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9892352);
Constant_3_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9893376);
Reshape_32_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9893376);
Constant_4_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9894400);
Reshape_36_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9894400);
Constant_7_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9895424);
Reshape_48_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9895424);
Constant_8_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9896448);
Reshape_52_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9896448);
h_2 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9897472);
c_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9898496);
Reshape_76_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9897472);
tensor_84 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+9899520);
Result_101_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+9899520);
Result_100_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9897472);
Result_99_0 = (float*)(group_persist_ROCM_GPU0_allocator_memory_pool+9898496);
// tensor_87 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+18446744073709551615);
// Result_98_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+18446744073709551615);
Result_97_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+3888192);
Constant_93_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+9899584);
Constant_91_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+9899648);
Sum_90_0 = (int64_t*)(group_persist_ROCM_GPU0_allocator_memory_pool+9899520);
cond_0 = (char*)(group_persist_ROCM_GPU0_allocator_memory_pool+9899712);
Result_96_0 = (char*)(group_persist_ROCM_GPU0_allocator_memory_pool+9899712);
...
extern void ArgMax_float_int64_t_cuda_ArgMax_84_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, float* input0, int64_t* output0) {
    hipLaunchKernelGGL((ArgMax_float_int64_t_cuda_ArgMax_84), grids, blocks, mem, stream, input0, output0);
}
...
extern void Greater_int64_t_int64_t_char_cuda_Greater_92_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, int64_t* input0, int64_t* input1, char* output0) {
    hipLaunchKernelGGL((Greater_int64_t_int64_t_char_cuda_Greater_92), grids, blocks, mem, stream, input0, input1, output0);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// hipLaunchKernelGGL((BatchMatMul_float_float_float_cuda_BatchMatMul_24), dim3(32, 1, 1), dim3(256, 1, 1), 0, 0, Reshape_22_0, Reshape_23_0, BatchMatMul_24_0);
// hipLaunchKernelGGL((BatchMatMul_float_float_float_cuda_BatchMatMul_28), dim3(32, 1, 1), dim3(256, 1, 1), 0, 0, Reshape_26_0, Reshape_27_0, BatchMatMul_28_0);
// Deduped function map: <src_function_name : deduped_function_name>
// BatchMatMul_float_float_float_cuda_BatchMatMul_28 : BatchMatMul_float_float_float_cuda_BatchMatMul_24

// Node name:	BatchMatMul_24
...
// Output:
//	- name: BatchMatMul_24_0	type: float	shape: Shape{4, 1, 256}
__device__ __noinline__ void BatchMatMul_float_float_float_cuda_BatchMatMul_24_block_kernel(float* __restrict__ A, float* __restrict__ B, float* __restrict__ C, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_cuda_BatchMatMul_BatchMatMul_1(float* input0, float* input1, float* input2, float* input3, float* output0, float* output1)
{
    ...
    {
        BatchMatMul_float_float_float_cuda_BatchMatMul_24_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 32 && (int)blockIdx.x <= 63)
    {
        BatchMatMul_float_float_float_cuda_BatchMatMul_24_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 32 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_cuda_BatchMatMul_BatchMatMul_1_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, float* input0, float* input1, float* input2, float* input3, float* output0, float* output1) {
    hipLaunchKernelGGL((BlockFusionKernel_float_float_float_float_float_float_cuda_BatchMatMul_BatchMatMul_1), grids, blocks, mem, stream, input0, input1, input2, input3, output0, output1);
}
...
extern void Reshape_int64_t_int64_t_cuda_Reshape_86_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, int64_t* input0, int64_t* output0) {
    hipLaunchKernelGGL((Reshape_int64_t_int64_t_cuda_Reshape_86), grids, blocks, mem, stream, input0, output0);
}
// Node name:	And_95
// Description:	And
// Input:
...
extern void And_char_char_char_cuda_And_95_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, hipStream_t stream, char* input0, char* input1, char* output0) {
    hipLaunchKernelGGL((And_char_char_char_cuda_And_95), grids, blocks, mem, stream, input0, input1, output0);
}
...
//	- name: tensor_84	type: int64_t	shape: Shape{1}
// Output:
//	- name: Result_101_0	type: int64_t	shape: Shape{1}
...
#define NNFUSION_GRAPH_INPUT_SHAPE_0 {1}
#define NNFUSION_GRAPH_INPUT_DTYPE_1 int64_t
#define NNFUSION_GRAPH_INPUT_SHAPE_1 {}
...
#define NNFUSION_GRAPH_INPUT_SHAPE_3 {1, 256}
#define NNFUSION_GRAPH_INPUT_DTYPE_4 float
#define NNFUSION_GRAPH_INPUT_SHAPE_4 {50, 1, 3797}
#define NNFUSION_GRAPH_INPUT_DTYPE_5 int64_t
#define NNFUSION_GRAPH_INPUT_SHAPE_5 {50, 1}
#define NNFUSION_GRAPH_OUTPUT_DTYPE_0 char
#define NNFUSION_GRAPH_OUTPUT_SHAPE_0 {}
#define NNFUSION_GRAPH_OUTPUT_DTYPE_1 int64_t
#define NNFUSION_GRAPH_OUTPUT_SHAPE_1 {}
#define NNFUSION_GRAPH_OUTPUT_DTYPE_2 int64_t
#define NNFUSION_GRAPH_OUTPUT_SHAPE_2 {50, 1}
#define NNFUSION_GRAPH_OUTPUT_DTYPE_3 float
#define NNFUSION_GRAPH_OUTPUT_SHAPE_3 {1, 256}
#define NNFUSION_GRAPH_OUTPUT_DTYPE_4 float
#define NNFUSION_GRAPH_OUTPUT_SHAPE_4 {1, 256}
#define NNFUSION_GRAPH_OUTPUT_DTYPE_5 int64_t
#define NNFUSION_GRAPH_OUTPUT_SHAPE_5 {1}
#endif
...
//	- name: h_2	type: float	shape: Shape{1, 256}
// Output:
//	- name: Result_100_0	type: float	shape: Shape{1, 256}
void Result_float_float_cuda_lib_Result_100(hipStream_t stream, float* input0, float* output0)
{
    if (input0 != output0)
        CUDA_SAFE_CALL(hipMemcpyAsync(output0, input0,1024, hipMemcpyDeviceToDevice, stream));
}
extern "C" int kernel_entry(int64_t* Parameter_13_0, int64_t* Parameter_14_0, float* Parameter_15_0, float* Parameter_16_0, float* Parameter_17_0, int64_t* Parameter_18_0, char* Result_96_0, int64_t* Result_97_0, int64_t* Result_98_0, float* Result_99_0, float* Result_100_0, int64_t* Result_101_0)
{
// kernel_entry_init
 // name=blockfusion_kernel_104
BlockFusionKernel_float_int64_t_float_int64_t_int64_t_float_float_int64_t_cuda_GatherV2_GatherV2_Add_0_Call(dim3(17, 1, 1), dim3(256, 1, 1), 0, 0, Constant_0_0, Parameter_13_0, Parameter_17_0, Parameter_14_0, Constant_88_0, GatherV2_19_0, GatherV2_82_0, Result_97_0);
 // name=Reshape_78
...
// eliminated: Reshape_float_float_cuda_Reshape_27_Call(dim3(1024, 1, 1), dim3(256, 1, 1), 0, 0, Constant_2_0, Reshape_27_0);
 // name=h_0
Reshape_float_float_cuda_Reshape_21_Call(dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, Parameter_16_0, Reshape_21_0);
 // name=Reshape_26
...
// eliminated: Reshape_float_float_cuda_Reshape_23_Call(dim3(1024, 1, 1), dim3(256, 1, 1), 0, 0, Constant_1_0, Reshape_23_0);
 // name=Reshape_22
// eliminated: Reshape_float_float_cuda_Reshape_21_Call(dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, GatherV2_19_0, Reshape_22_0);
 // name=blockfusion_kernel_105
BlockFusionKernel_float_float_float_float_float_float_cuda_BatchMatMul_BatchMatMul_1_Call(dim3(64, 1, 1), dim3(256, 1, 1), 0, 0, Reshape_22_0, Reshape_23_0, Reshape_26_0, Reshape_27_0, BatchMatMul_24_0, BatchMatMul_28_0);
 // name=Reshape_29
...
BlockFusionKernel_float_int64_t_int64_t_int64_t_int64_t_float_int64_t_int64_t_int64_t_int64_t_float_float_float_float_float_float_float_float_cuda_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_GatherV2_2_Call(dim3(8, 1, 1), dim3(256, 1, 1), 0, 0, Reshape_25_0, Constant_30_0, Constant_38_0, Constant_46_0, Constant_54_0, Reshape_29_0, Constant_34_0, Constant_42_0, Constant_50_0, Constant_58_0, GatherV2_31_0, GatherV2_39_0, GatherV2_47_0, GatherV2_55_0, GatherV2_35_0, GatherV2_43_0, GatherV2_51_0, GatherV2_59_0);
 // name=Reshape_60
...
FusedKernel_float_float_float_float_cuda_Add_Reshape_Add_1_Call(dim3(15, 1, 1), dim3(256, 1, 1), 0, 0, Dot_77_0, Reshape_78_0, GatherV2_82_0, Add_83_0);
 // name=output_2
ArgMax_float_int64_t_cuda_ArgMax_84_Call(dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, Add_83_0, Result_101_0);
 // name=Result_101
// eliminated (extern_result_memory): Result_int64_t_int64_t_cuda_lib_Result_101(0, Result_101_0, Result_101_0);
 // name=Result_100
// eliminated (extern_result_memory): Result_float_float_cuda_lib_Result_100(0, Result_100_0, Result_100_0);
 // name=Result_99
// eliminated (extern_result_memory): Result_float_float_cuda_lib_Result_100(0, Result_99_0, Result_99_0);
 // name=@tmp_40
Reshape_int64_t_int64_t_cuda_Reshape_86_Call(dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, Parameter_14_0, Reshape_86_0);
 // name=ScatterND_87
tensor_87 = Parameter_18_0;
/* memref */ScatterND_int64_t_int64_t_int64_t_int64_t_cuda_ScatterND_87_Call(dim3(1, 1, 1), dim3(256, 1, 1), 0, 0, Parameter_18_0, Reshape_86_0, Result_101_0, Result_98_0);
 // name=Result_98
// eliminated (extern_result_memory): Result_int64_t_int64_t_cuda_lib_Result_98(0, Result_98_0, Result_98_0);
 // name=Result_97
// eliminated (extern_result_memory): Result_int64_t_int64_t_cuda_lib_Result_101(0, Result_97_0, Result_97_0);
 // name=@tmp_47
Less_int64_t_int64_t_char_cuda_Less_94_Call(dim3(1, 1, 1), dim3(1, 1, 1), 0, 0, Result_97_0, Constant_93_0, Less_94_0);
 // name=@tmp_43
Sum_int64_t_int64_t_cuda_Sum_90_Call(dim3(1, 1, 1), dim3(1, 1, 1), 0, 0, Result_101_0, Sum_90_0);
 // name=@tmp_45
Greater_int64_t_int64_t_char_cuda_Greater_92_Call(dim3(1, 1, 1), dim3(1, 1, 1), 0, 0, Sum_90_0, Constant_91_0, Greater_92_0);
 // name=cond_0
And_char_char_char_cuda_And_95_Call(dim3(1, 1, 1), dim3(1, 1, 1), 0, 0, Greater_92_0, Less_94_0, Result_96_0);
 // name=Result_96
// eliminated (extern_result_memory): Result_char_char_cuda_lib_Result_96(0, Result_96_0, Result_96_0);
CUDA_SAFE_CALL(hipDeviceSynchronize());return 0;
}
extern "C" void cuda_free()
{
CUDA_SAFE_CALL(hipSetDevice(0));
CUDA_SAFE_CALL(hipFree(group_0_ROCM_GPU0_allocator_memory_pool));
CUDA_SAFE_CALL(hipSetDevice(0));
CUDA_SAFE_CALL(hipFree(group_persist_ROCM_GPU0_allocator_memory_pool));
}
