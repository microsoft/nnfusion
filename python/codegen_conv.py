...
from d2ltvm import split_axis, conv_out_size, conv, padding, get_conv_data, bench_conv_tvm
...
print(kernel_code)
tvm_gflops = bench_conv_tvm(tiling, [(64, 64, 3)], 'cuda')
