...
def load_model(model_path: str):
    ...
    codegen_flags = {'autodiff': False, 'training_mode': False, 'extern_result_memory': True, 'codegen_unexist_kernel': True, 'product_name': 'V100', 'max_block_dim': 128}
...
class GenModel(torch.autograd.Function):
    forward_executor = load_model("attention_bs64_0-forward.onnx")

    @staticmethod
    def forward(ctx, _i0, _i1, _i2, _i3):
        ...
        return _o0, _o1, _o2, _o3

    @staticmethod
    def backward(ctx, _r0, _r1, _r2, _r3):
