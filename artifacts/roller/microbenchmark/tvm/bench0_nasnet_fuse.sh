...
python3 $1/conv2d_tuning.py 128 3 331 331 96 3 3 2 1 VALID add relu
python3 $1/conv2d_tuning.py 128 96 165 165 42 1 1 1 1 SAME add
python3 $1/conv2d_tuning.py 128 96 83 83 42 1 1 1 1 SAME add relu
python3 $1/conv2d_tuning.py 128 42 83 83 42 1 1 1 1 VALID add
python3 $1/conv2d_tuning.py 128 168 83 83 84 1 1 1 1 SAME add
python3 $1/conv2d_tuning.py 128 96 83 83 42 1 1 1 1 SAME
python3 $1/conv2d_tuning.py 128 84 42 42 84 1 1 1 1 VALID add relu
python3 $1/conv2d_tuning.py 128 84 42 42 84 1 1 1 1 VALID add
python3 $1/conv2d_tuning.py 128 336 42 42 168 1 1 1 1 SAME add
python3 $1/conv2d_tuning.py 128 168 42 42 168 1 1 1 1 VALID add relu
python3 $1/conv2d_tuning.py 128 168 42 42 168 1 1 1 1 VALID add
python3 $1/conv2d_tuning.py 128 168 42 42 84 1 1 1 1 SAME
python3 $1/conv2d_tuning.py 128 1008 42 42 168 1 1 1 1 SAME add
python3 $1/conv2d_tuning.py 128 1008 42 42 336 1 1 1 1 SAME add
python3 $1/conv2d_tuning.py 128 336 21 21 336 1 1 1 1 VALID add relu
python3 $1/conv2d_tuning.py 128 336 21 21 336 1 1 1 1 VALID add
python3 $1/conv2d_tuning.py 128 1344 21 21 336 1 1 1 1 SAME add
python3 $1/conv2d_tuning.py 128 1008 21 21 168 1 1 1 1 SAME
python3 $1/conv2d_tuning.py 128 2016 21 21 336 1 1 1 1 SAME add
python3 $1/conv2d_tuning.py 128 2016 21 21 672 1 1 1 1 SAME add
python3 $1/conv2d_tuning.py 128 672 11 11 672 1 1 1 1 VALID add relu
python3 $1/conv2d_tuning.py 128 672 11 11 672 1 1 1 1 VALID add
python3 $1/conv2d_tuning.py 128 2688 11 11 672 1 1 1 1 SAME add
python3 $1/conv2d_tuning.py 128 2016 11 11 336 1 1 1 1 SAME
python3 $1/conv2d_tuning.py 128 4032 11 11 672 1 1 1 1 SAME add
