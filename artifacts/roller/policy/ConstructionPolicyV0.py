...
class ConstructionPolicyV0(PolicyBase):
    """
        Constructing building blocks using BFS per level
    """
    ...
    def divide_schedules(self, raw_schedules, mem_level):
        ...
        for schedule in raw_schedules:
            ...
            compute_throughput = self.compute_db.lookup(64,8,1) * self.arch.compute_max_core[0]
    ...
    def emit_raw_candidates_level(self, ll_schedules, mem_level):
        ...
        if mem_level == 0:
            stride_reduce_arch['k'] = self.arch.transaction_size[mem_level] // self.size_of_type
            #stride_reduce_arch['k'] = 32
            stride_spatial_arch[-1] = self.arch.transaction_size[mem_level] // self.size_of_type
    ...
    def emit_raw_configs(self):
        ...
        def try_scale_out(schedules):
            for schedule in schedules:
                ...
                # hardcode for v100
                if parallelism > 4 * self.arch.compute_max_core[0]:
                    return True
            return False
