...
set output "irregular_shape_v100.pdf"
plot newhistogram lt 1, \
     'irregular_shape_v100.dat' 	u 2:xtic(1) title "Ansor" fs pattern 6 lt 1 lc 4, \
						''	u 3 title "Roller-B" fs pattern 7 ls -1 lc 2, \
						''	u 4 title "Roller-F" fs solid 0.4 ls -1 lc 6, \
						''	u 5 title "Roller-P0.4" fs pattern 2 ls -1 lc -1,\
						''	u 6 title "Roller-P1.0" fs pattern 3 ls -1 lc -1
