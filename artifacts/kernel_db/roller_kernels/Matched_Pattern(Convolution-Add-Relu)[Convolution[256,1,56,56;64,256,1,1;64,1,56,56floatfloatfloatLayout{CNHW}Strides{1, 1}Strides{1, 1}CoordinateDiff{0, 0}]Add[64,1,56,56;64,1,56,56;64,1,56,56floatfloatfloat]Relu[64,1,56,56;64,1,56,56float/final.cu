...
extern "C" __global__ void __launch_bounds__(128) default_function_kernel0(float* __restrict__ data, float* __restrict__ kernel, float* __restrict__ bias, float* __restrict__ conv_unpad) {
  ...
  conv_unpad[((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)))] = max((conv_local[(0)] + bias[((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 25088))] = max((conv_local[(4)] + bias[(((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 8))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 50176))] = max((conv_local[(8)] + bias[(((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 16))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 75264))] = max((conv_local[(12)] + bias[(((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 24))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 16))] = max((conv_local[(1)] + bias[((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 25104))] = max((conv_local[(5)] + bias[(((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 8))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 50192))] = max((conv_local[(9)] + bias[(((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 16))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 75280))] = max((conv_local[(13)] + bias[(((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 24))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 32))] = max((conv_local[(2)] + bias[((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 25120))] = max((conv_local[(6)] + bias[(((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 8))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 50208))] = max((conv_local[(10)] + bias[(((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 16))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 75296))] = max((conv_local[(14)] + bias[(((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 24))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 48))] = max((conv_local[(3)] + bias[((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 25136))] = max((conv_local[(7)] + bias[(((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 8))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 50224))] = max((conv_local[(11)] + bias[(((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 16))]), 0.000000e+00f);
  conv_unpad[(((((((((int)blockIdx.x) / 49) * 100352) + ((((int)threadIdx.x) >> 4) * 3136)) + ((((int)blockIdx.x) % 49) * 64)) + (((int)threadIdx.x) & 15)) + 75312))] = max((conv_local[(15)] + bias[(((((((int)blockIdx.x) / 49) * 32) + (((int)threadIdx.x) >> 4)) + 24))]), 0.000000e+00f);
}
