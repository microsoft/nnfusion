...
extern "C" __global__ void __launch_bounds__(128) default_function_kernel0(float* __restrict__ data, float* __restrict__ kernel, float* __restrict__ bias, float* __restrict__ conv_unpad) {
  ...
  for (int ra_fused0_outer = 0; ra_fused0_outer < 144; ++ra_fused0_outer) {
    __syncthreads();
    data_pad_shared[((int)threadIdx.x)] = (((((((((((int)blockIdx.x) % 7) * 8) + (((int)threadIdx.x) & 7)) < 49) && (0 < ((((((((int)blockIdx.x) % 7) * 8) + (((int)threadIdx.x) & 7)) % 49) / 7) + ((((ra_fused0_outer * 5) + (((int)threadIdx.x) >> 3)) % 9) / 3)))) && (((((((((int)blockIdx.x) % 7) * 8) + (((int)threadIdx.x) & 7)) % 49) / 7) + ((((ra_fused0_outer * 5) + (((int)threadIdx.x) >> 3)) % 9) / 3)) < 8)) && (0 < ((((((int)threadIdx.x) & 7) + (((int)blockIdx.x) % 7)) % 7) + (((ra_fused0_outer * 2) + (((int)threadIdx.x) >> 3)) % 3)))) && (((((((int)threadIdx.x) & 7) + (((int)blockIdx.x) % 7)) % 7) + (((ra_fused0_outer * 2) + (((int)threadIdx.x) >> 3)) % 3)) < 8)) ? data[(((((((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 3)) / 9) * 49) + (((((((int)blockIdx.x) % 7) * 8) + (((int)threadIdx.x) & 7)) / 7) * 7)) + (((((ra_fused0_outer * 5) + (((int)threadIdx.x) >> 3)) % 9) / 3) * 7)) + (((((int)threadIdx.x) & 7) + (((int)blockIdx.x) % 7)) % 7)) + (((ra_fused0_outer * 2) + (((int)threadIdx.x) >> 3)) % 3)) - 8)] : 0.000000e+00f);
    data_pad_shared[(((int)threadIdx.x) + 128)] = (((((((((((int)blockIdx.x) % 7) * 8) + (((int)threadIdx.x) & 7)) < 49) && (0 < ((((((((int)blockIdx.x) % 7) * 8) + (((int)threadIdx.x) & 7)) % 49) / 7) + (((((ra_fused0_outer * 5) + (((int)threadIdx.x) >> 3)) + 7) % 9) / 3)))) && (((((((((int)blockIdx.x) % 7) * 8) + (((int)threadIdx.x) & 7)) % 49) / 7) + (((((ra_fused0_outer * 5) + (((int)threadIdx.x) >> 3)) + 7) % 9) / 3)) < 8)) && (0 < ((((((int)threadIdx.x) & 7) + (((int)blockIdx.x) % 7)) % 7) + ((((ra_fused0_outer * 5) + (((int)threadIdx.x) >> 3)) + 1) % 3)))) && (((((((int)threadIdx.x) & 7) + (((int)blockIdx.x) % 7)) % 7) + ((((ra_fused0_outer * 5) + (((int)threadIdx.x) >> 3)) + 1) % 3)) < 8)) ? data[((((((((((ra_fused0_outer * 32) + (((int)threadIdx.x) >> 3)) + 16) / 9) * 49) + (((((((int)blockIdx.x) % 7) * 8) + (((int)threadIdx.x) & 7)) / 7) * 7)) + ((((((ra_fused0_outer * 5) + (((int)threadIdx.x) >> 3)) + 7) % 9) / 3) * 7)) + (((((int)threadIdx.x) & 7) + (((int)blockIdx.x) % 7)) % 7)) + ((((ra_fused0_outer * 5) + (((int)threadIdx.x) >> 3)) + 1) % 3)) - 8)] : 0.000000e+00f);
